      ...
      .end(async (err, res) => {
        ...
        testClientDb.collection('files')
          ...
          .toArray((err, docs) => {
		    ...
		    it('pOST /files with missing name', () => new Promise((done) => {
    const fileData = {
      type: 'folder',
    };
    chai.request('http://localhost:5000')
      ...
      .end(async (err, res) => {
        ...
        testClientDb.collection('files')
          ...
          .toArray((err, docs) => {
		    ...
		    it('pOST /files with missing type', () => new Promise((done) => {
    const fileData = {
      name: fctRandomString(),
    };
    chai.request('http://localhost:5000')
      ...
      .end(async (err, res) => {
        ...
        testClientDb.collection('files')
          ...
          .toArray((err, docs) => {
		    ...
		    it('pOST /files with missing data if type != folder', () => new Promise((done) => {
    const fileData = {
      name: fctRandomString(),
      type: 'file',
    };
      ...
      .end(async (err, res) => {
        ...
        testClientDb.collection('files')
          ...
          .toArray((err, docs) => {
		    ...
		    it('pOST /files with invalid parentId', () => new Promise((done) => {
    const fileData = {
      name: fctRandomString(),
      type: 'folder',
