...
describe('gET /disconnect', () => {
  ...
  it('gET /disconnect with an incorrect token', () => new Promise((done) => {
      ...
      .then((keys) => {
        ...
        chai.request('http://localhost:5000')
          ...
          .end(async (err, res) => {
		    ...
		    it('gET /disconnect with an correct token', () => new Promise((done) => {
    redisKeysAsync('auth_*')
      .then((keys) => {
        chai.expect(keys.length).to.equal(1);
    ...
    chai.request('http://localhost:5000')
      ...
      .end(async (err, res) => {
        ...
        chai.expect(resError).to.equal('Unauthorized');
		    ...
		    it('gET /users/me with incorrect token', () => new Promise((done) => {
    chai.request('http://localhost:5000')
      .get('/users/me')
      .set('X-Token', 'nope')
      .end(async (err, res) => {
