...
describe('gET /files/:id/data', () => {
  ...
  it('gET /files/:id/data with an unpublished file not present locally linked to :id and user authenticated and owner', () => new Promise((done) => {
  ...
  it('gET /files/:id/data with an published file not present locally linked to :id and user authenticated and owner', () => new Promise((done) => {
    chai.request('http://localhost:5000')
