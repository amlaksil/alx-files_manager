...
describe('gET /files/:id/data', () => {
  ...
  it('gET /files/:id/data with an unpublished folder linked to :id but user unauthenticated', () => new Promise((done) => {
  ...
  it('gET /files/:id/data with a published folder linked to :id but user unauthenticated', () => new Promise((done) => {
    chai.request('http://localhost:5000')
