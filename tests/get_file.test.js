...
describe('gET /files/:id/data', () => {
  ...
  it('gET /files/:id/data with no file linked to :id', () => new Promise((done) => {
    chai.request('http://localhost:5000')
      ...
      .end(async (err, res) => {
        ...
        chai.expect(resError).to.equal('Not found');
		    ...
		    it('gET /files/:id/data with an unpublished file linked to :id but user unauthenticated', () => new Promise((done) => {
    chai.request('http://localhost:5000')
